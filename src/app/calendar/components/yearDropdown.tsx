...
export default function YearDropdown({ selected, setSelected, planetState }) {
    ...
    // });
    const filteredYears =
        planetState.getPlanetState == 'Earth'
            ? earthYears.filter((year) =>
                  year.toString().toLowerCase().includes(query.toLowerCase())
              )
            : planetState.getPlanetState == 'Mars'
            ? marsYears.filter((year) =>
                  year.toString().toLowerCase().includes(query.toLowerCase())
              )
