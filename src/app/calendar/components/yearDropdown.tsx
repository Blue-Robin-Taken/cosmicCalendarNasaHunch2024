...
export default function YearDropdown() {
  ...
  const [selected, setSelected] = useState(earthYears[Number(ttime().toLocale('en-us').format('YYYY'))-1000])
  ...
  return (
    <div className="relative self-center w-36 z-10">
      <Combobox value={selected} virtual={{ options: filteredYears }} onChange={(value) => setSelected(value)} onClose={() => setQuery('')}>
        ...
        <ComboboxOptions anchor="bottom" className="!max-h-[12rem] w-[var(--input-width)] 
          ...
          {({ option: yyear }) => (
            <ComboboxOption value={yyear} className="data-[focus]:bg-dm-yellow-hl data-[disabled]:opacity-50 group flex 
